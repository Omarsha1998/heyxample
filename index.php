...
<div id="search_area">
    <input type="text" name="contactsearch" id="contactsearch" class="form-control input-md" autocomplete="off" placeholder="Search Contacts." />
</div>
<br>
        ...
        <div class="modal-body">
			...
			<div class="form-group">        
	      		<div class="col-sm-offset-4 col-sm-10">
	        		<button type="submit" data-id="<?php echo $id; ?>" id="edit" class="btn btn-default">Update</button>
	      		</div>
    		</div>
			</form>
			<br><br>
